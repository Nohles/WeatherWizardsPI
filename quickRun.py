...
requests.get("https:// *website* /api/sensor/create.php?temp="+str(temperature)+"&humidity="+str(humidity)+"&light="+str(ldr.value)+"&rain="+str(norain.value)+"&moisture="+str(nomoisture.value)+"&macAddress="+str(macAddress)+"&runID=$
#       sleep(5)
